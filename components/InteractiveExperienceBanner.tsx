...
export default function InteractiveExperienceBanner() {
  ...
  const [sunPower, setSunPower] = useState<number>(45); // 0 (full cold) to 100 (full hot sun)

  // Calculate current ambient temperature based on slider
    ...
    <section id="experiencia" className="py-20 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-5 sm:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-10">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-sky-500/10 border border-sky-400/20 text-sky-400 text-xs font-semibold uppercase tracking-wider mb-3">
          ...
          <p className="mt-3 text-slate-300 text-sm sm:text-base font-light">
            Alterne entre as visões para entender o combate ao calor e a precisão do nosso trabalho.
          </p>
        </div>
        ...
        <div className="flex flex-wrap items-center justify-center gap-3 mb-8">
          ...
          >
            ...
            <span>2. O Instalador em Ação</span>
          </button>
        ...
        {/* Main Display Cinema Stage (Garantindo que a imagem apareça 100%) */}
        <div className="relative rounded-[32px] overflow-hidden border border-sky-400/35 shadow-2xl">
          ...
          <AnimatePresence mode="wait">
            ...
            {activeTab === 'cooling' && (
              <motion.div
                ...
                className="relative min-h-[500px] sm:min-h-[580px] flex flex-col justify-between p-6 sm:p-10"
              >
                {/* Background 3D Render Image - ALWAYS VISIBLE */}
                  ...
                  <div 
                    ...
                    style={{
                      background: `radial-gradient(circle at 10% 40%, rgba(245, 158, 11, ${sunPower * 0.0035}) 0%, transparent 60%),
                                   ...
                                   linear-gradient(to top, rgba(2,9,20,0.85) 0%, rgba(2,9,20,0.1) 50%, rgba(2,9,20,0.6) 100%)`
                    }}
                  />
                </div>
                ...
                <div className="flex flex-wrap items-center justify-between gap-4 relative z-10">
                  <div className="p-3 px-4 rounded-2xl bg-[#04142b]/90 border border-sky-400/40 backdrop-blur-md flex items-center gap-3 shadow-xl">
                  ...
                  <div className="p-3 px-4 rounded-2xl bg-[#04142b]/90 border border-emerald-500/40 backdrop-blur-md text-right shadow-xl">
                ...
                <div className="relative z-10 max-w-xl mx-auto w-full p-6 rounded-3xl bg-[#04142b]/95 border border-sky-400/40 backdrop-blur-xl shadow-2xl">
                  ...
                  <p className="text-[11px] text-slate-300 text-center mt-3 font-light">
                    Arraste o controle para simular como a tecnologia Inverter neutraliza a radiação solar.
                  </p>
            ...
            {activeTab === 'installer' && (
              <motion.div
                ...
                className="relative min-h-[500px] sm:min-h-[580px] flex flex-col justify-between p-6 sm:p-10"
              >
                {/* Background Installer Photo - ALWAYS VISIBLE */}
                <div className="absolute inset-0 z-0">
                  <img
                    ...
                    className="w-full h-full object-cover object-center"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#020914] via-transparent to-black/50 pointer-events-none" />
                </div>

                {/* Top Badges */}
                <div className="flex flex-wrap items-center justify-between gap-4 relative z-10">
                  <div className="p-3 px-4 rounded-2xl bg-[#04142b]/95 border border-sky-400/40 backdrop-blur-md shadow-xl">
                  ...
                  <div className="p-3 px-4 rounded-2xl bg-emerald-950/90 border border-emerald-500/40 backdrop-blur-md shadow-xl">
                ...
                <div className="relative z-10 grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-4xl mx-auto w-full">
                  ...
                  <div className="p-4 rounded-2xl bg-[#04142b]/95 border border-sky-400/40 backdrop-blur-md shadow-2xl">
                  ...
                  <div className="p-4 rounded-2xl bg-[#04142b]/95 border border-sky-400/40 backdrop-blur-md shadow-2xl">
                    ...
                    <p className="text-xs text-slate-300 leading-relaxed font-light">
                      Zero tubos de alumínio frágil. Curvador hidráulico sem estrangular a passagem de gás.
                    </p>
                  </div>
                  ...
                  <div className="p-4 rounded-2xl bg-[#04142b]/95 border border-sky-400/40 backdrop-blur-md shadow-2xl">
                    ...
                    <p className="text-xs text-slate-300 leading-relaxed font-light">
                      Lona especial e aspirador acoplado para não deixar poeira na sua mobília ou piso.
                    </p>
                  </div>
                ...
                <div className="relative z-10 pt-4 flex items-center justify-between border-t border-sky-500/20">
                  ...
                  >
                    ...
                    <span>Agendar no WhatsApp: (11) 94732-1510</span>
                  </a>
                </div>
            ...
            {activeTab === 'unit' && (
              <motion.div
                ...
                className="relative min-h-[500px] sm:min-h-[580px] flex flex-col justify-between p-6 sm:p-10"
              >
                {/* Background 3D Unit Image - ALWAYS VISIBLE */}
                <div className="absolute inset-0 z-0">
                  <img
                    ...
                    className="w-full h-full object-cover object-center"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#020914] via-transparent to-black/40 pointer-events-none" />
                </div>
                ...
                <div className="flex items-center justify-between relative z-10">
                  ...
                  <span className="px-3.5 py-1.5 rounded-full bg-sky-500/20 border border-sky-400/30 text-sky-300 text-xs font-mono font-bold shadow-md">
                    Selo Procel A+++
                  </span>
                </div>

                {/* Bottom Features & Action */}
                <div className="relative z-10 max-w-2xl p-6 rounded-3xl bg-[#04142b]/95 border border-sky-400/40 backdrop-blur-xl shadow-2xl">
                  <h3 className="text-xl font-bold text-white mb-2">
                    Economia Máxima e Silêncio de 19 dB
                  </h3>
                  <p className="text-xs text-slate-300 leading-relaxed font-light mb-4">
                    O compressor inverter ajusta a rotação continuamente, mantendo a temperatura estável sem picos de energia.
                  </p>
                  ...
                  <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-3 border-t border-sky-500/20">
                    <div className="flex items-center gap-3 text-xs text-emerald-400 font-semibold">
                      ...
                      <span>Até 70% de economia na conta de luz</span>
                    </div>
